...
public class BoardFactory {
	...
	public BoardCreation makeBoard(String difficulty)
	{
        ...
        //Creating board by difficulty
		 if (difficulty.equals("Easy")) {
	            size = 7;
	            cellWidth = 90;
	            cellHeight = 84;
	            snakesDis.addAll(Arrays.asList(1, 1, 1, 1)); //Number of snakes per type
	            return new BoardCreation(7, 7, cellWidth, cellHeight, snakesDis, 4);
	        } else if (difficulty.equals("Medium")) {
	            size = 10;
	            cellWidth = 63;
	            cellHeight = 59;
	            snakesDis.addAll(Arrays.asList(2, 1, 2, 1)); //Number of snakes per type
	            return new  BoardCreation(10, 10, cellWidth, cellHeight, snakesDis, 6);
	        } else if (difficulty.equals("Hard")) {
	            size = 13;
	            cellWidth = 48;
	            cellHeight = 45;
	            snakesDis.addAll(Arrays.asList(2, 2, 2, 2)); //Number of snakes per type
